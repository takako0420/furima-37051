class TradingBuyer
  include ActiveModel::Model
    attr_accessor :item_id, :user_id, :post_number, :prefecture_id, :city, :address, :building_name, :phone_number, :trading_id, :token
  ...
  def save
    ...
    Buyer.create(post_number: post_number, prefecture_id: prefecture_id, city: city, address: address, building_name: building_name, phone_number: phone_number, trading_id: trading.id )
  end
end